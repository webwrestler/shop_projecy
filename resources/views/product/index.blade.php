        ...
        <div class="container">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                    <li role="presentation"><a role="menuitem" tabindex="-1" name="Bags" href="#">Bags</a></li>
                    <li role="presentation"><a role="menuitem" tabindex="-1" name="Belt" href="#">Belts</a></li>
                    <li role="presentation"><a role="menuitem" tabindex="-1" name="Purce" href="#">Purces</a></li>
                </ul>
            </div>
        </div>
        <!-- /Dropdown -->
        ...
        <div id="portfolio" class="container">
            <div class="row">
                ...
                @foreach($products as $product)
                    ...
                    <a href="#" class="image full"><img src="{{$product->image}}" alt=""></a>
